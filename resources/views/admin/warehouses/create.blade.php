...
<div class="card" style="background: white; padding: 2rem; border-radius: 12px; box-shadow: var(--shadow); max-width: 600px; margin: 0 auto;">
    <form action="{{ route('admin.warehouses.store') }}" method="POST">
        ...
        <div style="display: flex; gap: 1rem; justify-content: flex-end;">
            ...
            <button type="submit" style="padding: 10px 25px; background: var(--primary); color: black; border: 1px solid #e2e8f0; border-radius: 8px; cursor: pointer; font-weight: 600;">Create Warehouse</button>
        </div>
    </form>
</div>
@endsection
