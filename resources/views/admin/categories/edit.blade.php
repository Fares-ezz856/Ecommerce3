        ...
        <div style="margin-bottom: 2rem; border-bottom: 2px solid #f1f5f9; padding-bottom: 1rem;">
            ...
            <div id="lang-en">
                <div class="form-group" style="margin-bottom: 1.5rem;">
                    ...
                    <input type="text" name="name_en" value="{{ $category->getTranslation('name', 'en') }}" class="form-control" required style="width: 100%; padding: 10px; border: 1px solid #e2e8f0; border-radius: 8px;">
                </div>
                <div class="form-group" style="margin-bottom: 1.5rem;">
                    <label style="display: block; margin-bottom: 0.5rem; font-weight: 600;">Description (EN)</label>
                    <textarea name="description_en" rows="3" style="width: 100%; padding: 10px; border: 1px solid #e2e8f0; border-radius: 8px;">{{ $category->getTranslation('description', 'en') }}</textarea>
                </div>
            </div>
            ...
            <div id="lang-ar" style="display: none;" dir="rtl">
                <div class="form-group" style="margin-bottom: 1.5rem;">
                    ...
                    <input type="text" name="name_ar" value="{{ $category->getTranslation('name', 'ar') }}" class="form-control" required style="width: 100%; padding: 10px; border: 1px solid #e2e8f0; border-radius: 8px;">
                </div>
                <div class="form-group" style="margin-bottom: 1.5rem;">
                    <label style="display: block; margin-bottom: 0.5rem; font-weight: 600;">الوصف (AR)</label>
                    <textarea name="description_ar" rows="3" style="width: 100%; padding: 10px; border: 1px solid #e2e8f0; border-radius: 8px;">{{ $category->getTranslation('description', 'ar') }}</textarea>
                </div>
            </div>
        </div>
